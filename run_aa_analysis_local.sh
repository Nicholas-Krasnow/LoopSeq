...
# Local version of AA analysis script (no qsub)
# Run with: bash run_aa_analysis_local.sh
...
OUTPUT_DIR="aa_analysis_results_A1_local_1based"

# Create output directory
mkdir -p "$OUTPUT_DIR"

echo "Starting local AA analysis..."
